...
agent.upload_document("data/processed/pokemon_kb.txt", max_sentences_per_chunk=8, split_mode="lines")
...
agent.discuss_document(semantic_query, doc_name="pokemon_kb.txt", semantic_top_k=5, semantic_debug=True)
# 5. start the chat with a question about the uploaded content.
message = input("Enter your question about the uploaded document: ")
agent.discuss_document(message, doc_name="pokemon_kb.txt", semantic_top_k=5, semantic_debug=True)
